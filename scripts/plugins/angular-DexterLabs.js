(function (angular) {
    angular.module("ui.DexterLabs", ["ui.DexterLabs.ngModel", "ui.DexterLabs.collapsible", "ui.DexterLabs.toast", "ui.DexterLabs.sidenav", "ui.DexterLabs.DexterLabs_select", "ui.DexterLabs.dropdown", "ui.DexterLabs.inputfield", "ui.DexterLabs.input_date", "ui.DexterLabs.tabs", "ui.DexterLabs.pagination", "ui.DexterLabs.pushpin", "ui.DexterLabs.scrollspy", "ui.DexterLabs.parallax","ui.DexterLabs.modal", "ui.DexterLabs.tooltipped",  "ui.DexterLabs.slider", "ui.DexterLabs.DexterLabsboxed"]);

    angular.module("ui.DexterLabs.ngModel", [])
    ...
    */
    angular.module("ui.DexterLabs.slider", [])
    ...
    angular.module("ui.DexterLabs.collapsible", [])
    ...
    angular.module("ui.DexterLabs.parallax", [])
    ...
    angular.module("ui.DexterLabs.toast", [])
            ...
            return {
                ...
                link: function (scope, element, attrs) {
                    element.bind(attrs.toast, function () {
                        ...
                        DexterLabs.toast(message, scope.duration ? scope.duration : toastConfig.duration, rounded);
                    });
                }
            };
        }]);

    angular.module('ui.DexterLabs.pushpin', [])
    ...
    angular.module("ui.DexterLabs.scrollspy", [])
    ...
    angular.module("ui.DexterLabs.tabs", [])
    ...
    angular.module("ui.DexterLabs.sidenav", [])
    ...
    angular.module("ui.DexterLabs.DexterLabs_select", [])
        .directive("DexterLabsSelect", ["$compile", "$timeout", function ($compile, $timeout) {
            return {
                link: function (scope, element, attrs) {
    ...
    angular.module("ui.DexterLabs.dropdown", [])
     ...
     */
    angular.module("ui.DexterLabs.inputfield", [])
            ...
            return {
                ...
                link: function (scope, element) {
                    $timeout(function () {
                        ...
                        element.find("> > .DexterLabs-textarea").each(function () {
                            var that = $(this);
                            that.addClass("DexterLabs-textarea");
                        ...
                        element.find('> > .DexterLabs-textarea, > > input').each(function (index, countable) {
     ...
     * Example:
     <input input-date
        ...
        on-stop="onStop()" />
     */
    angular.module("ui.DexterLabs.input_date", [])
        .directive('inputDate', ["$compile", "$timeout", function ($compile, $timeout) {
            // Fix for issue 46. This gotta be a bug in the DexterLabs code, but this fixes it.
     ...
     */
    angular.module("ui.DexterLabs.pagination", [])
     ...
     */
    angular.module("ui.DexterLabs.modal", [])
     ...
     */
    angular.module("ui.DexterLabs.tooltipped", [])
    ...
    /*     example usage:
    <!-- normal DexterLabsboxed -->
    <img DexterLabsboxed class="DexterLabsboxed responsive-img" width="650" src="images/sample-1.jpg">
    
    <!-- caption DexterLabsboxed -->
    <img DexterLabsboxed class="DexterLabsboxed" data-caption="A picture of some deer and tons of trees" width="250" src="iamges/nature_portrait_by_pw_fotografie-d63tx0n.jpg">
            
     */
    angular.module("ui.DexterLabs.DexterLabsboxed", [])
        .directive("DexterLabsboxed", ["$timeout", function($timeout){
            return {
                restrict: 'A',
                link: function(scope, element, attrs) {
                   
                    $timeout(function(){
                        element.DexterLabsbox();
                    });
